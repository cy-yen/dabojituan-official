...
$(function () {
    ...
    $(document).scroll(function () {
        ...
        if (top < 10)
            $("#j-jeader").removeClass("fixed");
        else if (top > 10)
            $("#j-jeader").addClass("fixed");
    ...
    $('#btnModal').on('click', function () {
        layer.open({
            ...
            shadeClose: true,
            skin: 'popInfo',
            content: '\<\div class="inner"><div class="hd"><i></i><h3>温馨提示</h3></div>\
      <div class="bd">' + modalContactString + '\
